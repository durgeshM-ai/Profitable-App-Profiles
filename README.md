...
- ### Data Analysis and Visualisation
	- __Python__
		...
		- [Web Scraping]() : Query a basic API to retrieve data about the International Space Station (ISS). We expect to learn how to query external data sources using an API and explore the basics of scraping data in the form of a simple request to retrieve information from the [Open Notify](http://open-notify.org/) API.
